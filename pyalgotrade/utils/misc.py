...
def compress(str_data):
    return base64.b64encode(zlib.compress(str_data.encode('utf-8'))).decode('ascii')


def decompress(base64_data):
    return zlib.decompress(base64.b64decode(base64_data)).decode('utf-8')


def decompress_or_original(base64_data):
    try:
        return zlib.decompress(base64.b64decode(base64_data)).decode('utf-8')
